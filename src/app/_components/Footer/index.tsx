  ...
  return (
    <footer className="cs_footer cs_primary_bg">
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-5">
            <div className="cs_footer_info">
              ...
              <p className="mt-4">
                Jsme kreativní reklamní agentura z Uherského Hradiště. Jsme připraveni pomoci vám a
                vaší firmě vizuálně růst.
              </p>

              <a
                href={`mailto:s5@s5.cz`}
                className="text-white hover:!text-primary animate-fade-up animate-once animate-ease-in"
              >
                s5@s5.cz
              </a>
            </div>
        ...
        <div className="cs_footer_nav">
          {navItems.map(({ link }, i) => {
            return <CMSLink key={i} {...link} />
          })}
        </div>
      </div>
      <div className="py-8 text-base text-center opacity-50">
        <div className="container">Copyright {new Date().getFullYear()}. Powered by STUDIO 5</div>
      </div>
    </footer>
  )
}
