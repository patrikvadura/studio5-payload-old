...
export async function Header() {
  ...
  return (
    <>
      <header
        className={`bg-white cs_site_header cs_style1 cs_sticky_header cs_site_header_full_width`}
      >
            ...
            <div className="cs_main_header_in">
              <div className="cs_main_header_left">
                <Link className="cs_site_branding logo-dark" href="/">
                  <svg xmlns="http://www.w3.org/2000/svg" width="150" fill="#000" viewBox="0 0 807 170">
                ...
                <Link className="cs_site_branding logo-white fill-black" href="/">
                  <Image
