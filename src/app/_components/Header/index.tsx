  ...
  return (
    <>
      <Navbar
        ...
        isBlurred={false}
        classNames={{
          wrapper: 'px-4 md:px-0 py-0',
        }}
      >
        <NavbarBrand>
          <Link href="/">
            <svg xmlns="http://www.w3.org/2000/svg" width="130" fill="#000" viewBox="0 0 807 170">
          ...
          {user && (
            <Link href="/admin">
              <Icon
                ...
                className="!text-secondary text-2xl hover:!text-primary transition duration-300 ease-in-out"
              />
            </Link>
          )}
        </NavbarContent>
